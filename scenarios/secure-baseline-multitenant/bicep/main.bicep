...
@description('Optional, default to DOTNETCORE:6.0 . Mandatory when webAppBaseOs is Linux. Kind of webapp runtime')
@allowed([
  'DOTNETCORE:8.0'
  'DOTNETCORE:7.0'
  'DOTNETCORE:6.0'
...
output openAIAccountName string = spoke.outputs.openAIAccountName
output sqlServerName string = (deployAzureSql)  ? spoke.outputs.sqlServerName : ''
output redisCacheId string = (deployRedis) ? spoke.outputs.redisCacheId : ''
