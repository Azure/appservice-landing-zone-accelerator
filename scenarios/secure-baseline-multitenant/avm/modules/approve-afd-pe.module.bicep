...
module runAfdApproval 'br/public:avm/res/resources/deployment-script:0.2.1' = {
  ...
  params: {
    ...
    kind: 'AzureCLI'
    managedIdentities: {
      userAssignedResourcesIds: ['${userAssignedIdentity.outputs.resourceId}']
      }
...
resource existingScript 'Microsoft.Resources/deploymentScripts@2020-10-01' existing = {
  name: deploymentScriptName
}
