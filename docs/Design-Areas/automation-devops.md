...
-  Embrace [shift left](https://docs.microsoft.com/en-us/azure/devops/learn/devops-at-microsoft/shift-left-make-testing-fast-reliable) consistently security, by adding vulnerability and secret scanning tools like container scanning early in the pipeline.
