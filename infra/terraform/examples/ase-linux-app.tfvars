...
#
# Usage: cp examples/ase-linux-app.tfvars terraform.tfvars
# =============================================================================

# --- Required ---
location            = "uksouth"
resource_group_name = "rg-contoso-ase-linux-prod"
...
app_service_subnet_address_prefix             = "10.4.0.0/24"
private_endpoint_subnet_address_prefix        = "10.4.1.0/24"
app_service_environment_subnet_address_prefix = "10.4.2.0/24"
...
environment = "prod"
tags = {
  workload    = "contoso-ase-linux-app"
  environment = "prod"
