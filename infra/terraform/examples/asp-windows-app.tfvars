# =============================================================================
# App Service Plan — Windows Code-Based Web App (no ASE)
#
# Deploys a Premium v3 Windows App Service Plan with a .NET code-based
...
#
# Usage: cp examples/asp-windows-app.tfvars terraform.tfvars
# =============================================================================

# --- Required ---
location            = "uksouth"
resource_group_name = "rg-contoso-asp-win-prod"
...
app_service_subnet_address_prefix      = "10.6.0.0/24"
private_endpoint_subnet_address_prefix = "10.6.1.0/24"
...
environment = "prod"
tags = {
  workload    = "contoso-asp-windows-app"
  environment = "prod"
